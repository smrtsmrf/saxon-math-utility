...
module.exports = {
    sendEmail: function(req, res, next) {
        ...
        var postDo = req.body.doReason ? '<b>Reason: </b>' + req.body.doReason : '';
        ...
        var postSkip = req.body.skipReason ? '<b>Reason: </b>' + req.body.skipReason : '';
